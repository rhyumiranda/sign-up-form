...
function validatePhone() {
  ...
  phoneInput.addEventListener("input", (event) => {
    ...
    if (phoneReg.test(phoneInputVal)) {
      ...
      phoneError.textContent =
        "Alphabetical and special chracters are not allowed.";
    }
...
function validatePassword() {
  ...
  pwInput.addEventListener("input", () => {
    ...
    if (digitReg.test(pwInputVal) || pwInputVal == "") {
      ...
      singleDigError.textContent =
        "Password must have at least a single digit from 0-9.";
    }
    ...
    if (minmaxReg.test(pwInputVal) || pwInputVal == "") {
      ...
      minmaxError.textContent =
        "Password must be longer than 8 and less than 16 characters.";
    }
...
function initializePlaceholder() {
  ...
  showPlaceholder(phoneInput, "0000000000");
}
